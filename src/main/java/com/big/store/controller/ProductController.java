package com.big.store.controller;

import com.big.store.dao.CategoryDAO;
import com.big.store.dao.ProductDAO;
import com.big.store.enitity.Category;
import com.big.store.enitity.Product;
import com.big.store.form.EditProductForm;
import com.big.store.form.CreateProductForm;
...
public class ProductController {
    ...
    public ModelAndView createProduct(@Valid CreateProductForm form, BindingResult bindingResult) throws Exception {
        ModelAndView result = new ModelAndView("product/productUpdate");
