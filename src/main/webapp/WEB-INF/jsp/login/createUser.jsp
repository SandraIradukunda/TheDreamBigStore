...
<script type="text/javascript">
	...
	<style type="text/css" >
		...
		* {
		...
		/* Header/Blog Title */
		.bg-light {
			background-color: rgba(242, 98, 247, 0.85) !important;
		}

		.container {
			margin-top: 10px;
			padding: 10px;
			background-color: #8f62f7 !important;
		}
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="/createUser">Create User</a></li>
	...
	<div class="mb-3">
		...
		<select  class="form-label" name="role">
			...
			<option value="Seller" >Donor</option>
		</select>
	</div>
	<div class="mb-3">
